...
<script>
	...
	function myFunction(){
		var b=document.getElementById('complaintno').value;
		var c=b.length;
		if(b==null || b=="")
		{
			alert("Please Enter Your  Complaint No.");
...
<br>
<br>
<form method="POST" action="http://localhost/project4/backend/status.php">
<fieldset style="width:80%;border: 3.5px solid #4CAF50;border-radius: 25px;margin-left:9%;">
<legend style="font-size:35px;color:#333;">Complaint Status</legend>
<br><br>
	<center>
	<div id="dv">
		<?php 
                                ...
                                $errors = array(
                                    1=>" Complaint Number does not Exist.",
                                    2=>"Complaint No. ".$_SESSION['refno']." is ".$_SESSION['status']
                                  );
	...
	<tr>
	<td width="22%">Complaint No.  :   <d>*</d></td>
	<td><input type="text" size="30" placeholder="Complaint No" id="complaintno" name="complaintno" style="padding-left:4px;"/></td>
	</tr>
	<tr>
...
<?php
      ...
      $_SESSION['recent'] = "complaint_status.php";
?>
